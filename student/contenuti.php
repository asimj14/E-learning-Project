...
<body>
<h2>  
<p class="sinistro" align="left"><a class="a2" href="/elearning/logsign/student/mycorses.php">Back</a></p>
  ...
  echo"<center>";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<tr>
                  ...
                  <tr><td>". "<a class='a1' href='cfiles.php?idcorso=" .$row['idcorso']. "'>"."<center>View attachments</center></a>" ."</td></tr>";
